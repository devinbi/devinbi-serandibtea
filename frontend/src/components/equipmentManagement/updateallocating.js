                        ...
                        <form id="contact-form" class="form" action="#" method="POST" role="form" onSubmit={sendData}>
                            ...
                            <div className="row">
                                <div class="form-group col-sm">
                                    ...
                                    <input type="text" class="form-control formInput" id="VehicleBrand" name="VehicleBrand" tabindex="1" required
                                ...
                                <div class="form-group col-sm">
                                    ...
                                    <input type="text" class="form-control formInput" id="vehModal" name="vehModal"  tabindex="2" required
                            ...
                            <div className="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input required type="text" class="form-control formInput" id="InsCom" name="InsCom" tabindex="2" 
                                        value={result}
                                        onChange={(e) => {
