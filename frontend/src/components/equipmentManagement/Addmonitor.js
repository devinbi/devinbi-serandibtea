                    ...
                    <div class="container border-top " >
                        ...
                        <form class="form" onSubmit={sendData}>
                            <div class="form pt-5 mb-2">
                                    ...
                                    <input type="text" class="form-control formInput" id="expenseid" pattern="[E][0-9]{4}" placeholder="Enter Monitor ID"
                                    onChange={(e)=>{
                        ...
                        <div class="form-group1">
                            ...
                            <div class="form mb-2">
                                ...
                                <option id="manufacturing">Good Condition</option>
                                <option id="office use"> Bad Condition</option>
                               </select>
